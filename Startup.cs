...
namespace Fox.Microservices.Clinical
{
    public class Startup: BaseStartup
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "FOX Microservices - Clinical API", Version = "v1" });
                var filePath = Path.Combine(System.AppContext.BaseDirectory, "Fox.Microservices.Clinical.xml");
